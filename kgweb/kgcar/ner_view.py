        ...
        for pair in ner_list:
            ...
            if tempword(pair[1]):
                text += "<a href='#'  data-original-title='" + \
                        get_ner_info(pair[1]) + "(暂无资料)'  data-placement='top' data-trigger='hover' data-content='" \
                        + get_detail_ner_info(pair[1]) + "' class='popovers'>" + pair[0] + "</a>"
                continue

            text += "<a href='detail.html?title=" + pair[0] + "'  data-original-title='" + \
                    get_ner_info(pair[1]) + "'  data-placement='top' data-trigger='hover' data-content='" + \
                    get_detail_ner_info(pair[1]) + "' class='popovers'>" + pair[0] + "</a>"
